module Nfse
  module Fortaleza
    class Services::ConsultarLoteRps
      module Result
        class Success
          ...
          def initialize(body:)
            ...
            @notas_fiscais = body.dig("ns3:ConsultarLoteRpsResposta", "ListaNfse", "CompNfse").map do |nfse|
              NotaFiscal.new(nfse)
            end
          end
        ...
        class Failure
          ...
          def initialize(body:)
            ...
            result = body.dig("ns3:ConsultarLoteRpsResposta", "ListaMensagemRetorno", "MensagemRetorno")
      ...
      def call
        ...
        response = client.call(:consultar_lote_rps_v3, message: {
          "Cabecalho!" => cabecalho_xml,
          "ConsultarLoteRpsEnvio!" => data_xml # NOTE: the "!" character tells Gyoku to not escape the content.
        })
